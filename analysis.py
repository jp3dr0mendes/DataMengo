...
print("teste")
print(os.getenv(r'BRASILEIRO_CARTOES'))

df_brasileiro_cards = pd.read_csv(os.getenv(r'BRASILEIRO_CARTOES'))
df_brasileiro_full = pd.read_csv(os.getenv(r'BRASILEIRO_FULL')) # PARTIDAS
df_brasileiro_stats = pd.read_csv(os.getenv(r'BRASILEIRO_ESTATISTICAS'))
df_brasileiro_gols = pd.read_csv(os.getenv(r'BRASILEIRO_GOLS'))
...
#     # 'resultado': df_fla_placar['resultado'].values.tolist
